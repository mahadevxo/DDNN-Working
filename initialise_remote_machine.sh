...
bash -e -c 'cd DDNN-Working/src/pruning/taylor_series/better-pruning && curl -L -o ./imagenetmini-1000.zip https://www.kaggle.com/api/v1/datasets/download/ifigotin/imagenetmini-1000 && sudo apt install -y unzip && unzip imagenetmini-1000.zip'
