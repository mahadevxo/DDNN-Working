class RewardFuntion:
    ...
    def _accuracy_reward(self, accuracy_new) -> float:
    ...
    def _model_size_reward(self, model_size_new, model_size_previous) -> float:
    ...
    def _comp_time_reward(self, comp_time_new, comp_time_previous) -> float:
